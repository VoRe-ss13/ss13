...
/datum/player_tips/proc/pick_tip(var/isSpecific)
	...
	switch(choice)
		if("general")
			...
			prob(60); "[info] We have a wiki that is actively updated! Please check it out at https://wiki.torchstation13.net/index.php/Chomp_Station_Wiki for help!", //TORCHEdit - Torch links
			...
			prob(30); "[info] Having difficulties getting started? Pressing F3 to speak and typing '; Hello! I'm a new hire. Could someone please give me a tour?' or as appropriate for your character is a good way to start! More help available at: https://wiki.torchstation13.net/index.php/The_Basics", //TORCHEdit - Torch links
		...
		if("roleplay")
			...
			return pick(
				...
				prob(25); "[info] While following the SOP is not mandatory, and you are free to break it (albeit, with potential in-character consequences), departments like security and medical do well to be familiar with them! https://wiki.torchstation13.net/index.php/Standard_Operating_Procedure", //TORCHEdit - Torch links
