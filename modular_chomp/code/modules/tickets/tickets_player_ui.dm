...
<<<<<<< HEAD:modular_chomp/code/modules/tickets/tickets_player_ui.dm
	return GLOB.tgui_admin_state // Remove this line to enable player-side ticket ui
	//return GLOB.tgui_ticket_state
=======
	return GLOB.tgui_ticket_state
>>>>>>> 0160eb3e68 ([MIRROR] up ports a bunch of TGS commands (#11173)):code/modules/tickets/tickets_player_ui.dm
