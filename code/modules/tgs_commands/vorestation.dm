...
<<<<<<< HEAD:code/modules/tgs/v5/chat_commands.dm
	return "Current server status:\n**Web Manifest:** <http://manifest.torchstation13.net/>\n**Players:** [counts]\n**Active:** [active]\n**Bar Statues:** [afks]\n**Bellied:** [bellied]\n\n**Round Duration:** [roundduration2text()]" //CHOMPEdit //TORCHEdit - Torch links
=======
	return "Current server status:\n**Web Manifest:** <http://manifest.chompstation13.net/>\n**Players:** [counts]\n**Active:** [active]\n**Bar Statues:** [afks]\n**Bellied:** [bellied]\n\n**Round Duration:** [roundduration2text()]\n**Current Map:** [map_name]" // CHOMPEdit
>>>>>>> c71ab6c9bd ([Manual MIRROR] dmapi manual update port (#11138)):code/modules/tgs_commands/vorestation.dm
