...
/datum/sprite_accessory/hair/awoohair //Bro didn't realize he commented out a non-restricted asset. Bruh momento, but irrelevent anyway
...
/datum/sprite_accessory/hair_accessory/verie_hair_glow
	...
	ignores_lighting = 1
	//ckeys_allowed = list("vitoras") // This probably won't come into play EVER but better safe than sorry //Just... bruh... If anyone is wondering what i'm going on about look at the historical diffs
 //Chomp REMOVE END
