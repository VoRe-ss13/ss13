...
//ChompREMOVE No ckey locked items on Chomp //ChaosStation change - There is no such thing as a snowflake, enabling for EVERYONE
...
/datum/sprite_accessory/tail/taur/teppi			// Mostly used as example/template/test subject as to how you use the 'big' taur sprites. Pls give it better icons before uncommenting... //ChaosStation Change - re-adding anyway
	name = "Teppi (Taur)"
	icon_state = "teppi_s"
